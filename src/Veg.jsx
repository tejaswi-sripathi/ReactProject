...
function Veg() {
  ...
  const currentProducts = vegProducts.slice(
    indexOfFirstProduct,
    indexOfLastProduct
  );
  ...
  return (
    <>
      ...
      <div className="itemsfullpage">
        <h1 className="text-center text-gradient mb-4">Fresh Vegetables...</h1>
          ...
          <nav>
            <ul className="pagination">
              ...
              <button
                ...
                onClick={() =>
                  setCurrentPage((prev) =>
                    Math.min(prev + 1, Math.ceil(vegProducts.length / productsperpage))
                  )
                }
                disabled={
                  currentPage ===
                  Math.ceil(vegProducts.length / productsperpage)
                }
              >
                Next
              </button>
